...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        while (true) {
            ...
            if (tempPokemon.attackLevel >=1 && tempPokemon.attackLevel < MAX_HIT_POINTS) {
                break;
            } else{
        ...
        int defense = MAX_HIT_POINTS - tempPokemon.attackLevel;
        System.out.println("Enter your defense level (1-" + defense + "):");
        while (true) {
            tempPokemon.defenseLevel = myScan.nextInt();
            if (tempPokemon.defenseLevel >=1 && tempPokemon.defenseLevel <= defense) {
                break;
            } else{
                System.out.println("Sorry. The defense level must be between 1 and " + defense + ":");
                continue;
            }
        }
